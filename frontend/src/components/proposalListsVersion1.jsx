...
const ProposalList = () => {
	...
	// Replace your existing useEffect with currentBlock with this:
	useEffect(() => {
	...
	useEffect(() => {
		// Only use polling on Sepolia network
		if (!chain || !governorAddress) return

		const pollingInterval = setInterval(() => {
			console.log("Polling for proposal status updates on Sepolia")
			fetchProposalEvents()
